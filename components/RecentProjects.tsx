    ...
    <section id="projects">
      <div className="py-20">
        <h1 className="heading">
          Some of my <span className="text-purple">latest projects</span>
        </h1>
            ...
            <div className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-96 w-[80vw]" key={item.id}>
              <PinContainer title="" href="">
                ...
                <div className="flex items-center justify-between mt-7 mb-3">
                  ...
                  {/* Live site link */}
                  <a href={item.link} target="_blank" rel="noopener noreferrer" className="flex justify-center items-center hover:underline">
